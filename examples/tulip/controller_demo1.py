...
sys_vars['loc'] = (0, 63)
sys_vars['stage'] = (0, 2)
sys_init = {'loc = 0','stage = 0'}
#sys_init = {'stage = 0'}

sys_safe = set()
# The transition of 'stage'
sys_safe |= {('((stage = 0) && (! (loc = '+str(dim)+'))) -> X (stage = 0)')}
sys_safe |= {('((stage = 0) && (loc = '+str(dim)+')) -> X (stage = 1)')}
sys_safe |= {('((stage = 1) && (! (loc = 21))) -> X (stage = 1)')}
sys_safe |= {('((stage = 1) && (loc = 21)) -> X (stage = 2)')}
sys_safe |= {('((stage = 2) && (! (loc = 0))) -> X (stage = 2)')}
